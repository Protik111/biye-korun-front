...
import { IconCircleCheck, IconCircleDashed, IconLock, IconMessages, IconRocket } from '@tabler/icons-react'
            ...
            <div className='basiscProfile__top'>
                <div className='flex align-center justify-between'>
                    <div className='flex align-center justify-between flex-gap-5'>
                        ...
                        <Badge variant="filled" color='pink'>2-Way</Badge>
                    </div>
                    <Button rightIcon={<IconRocket />} sx={{ backgroundColor: '#e64980', color: 'white' }} color='pink' variant="white">
                        Connect with her
                    </Button>
                </div>
