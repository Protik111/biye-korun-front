...
const ProfileSettings = ({
  ...
  const handleUpdateImage = (id) => {
    axios
      .patch(`user/update-image/${id}`, fieldData)
      .then((res) => {
    ...
    <div className="grid grid-cols-2 grid-cols-2-responsive grid-gap-20">
      <div>
        ...
        >
          <Group mt="xs">
            <Radio
              checked={fieldData.isBlur == true}
              color="pink"
              value={true}
              label="Yes"
            />
            <Radio
              checked={fieldData.isBlur == false}
              color="pink"
              value={false}
              label="No"
            />
        ...
        >
          <Group mt="xs">
            <Radio
              checked={fieldData.isVisible == true}
              color="pink"
              value={true}
              label="Yes"
            />
        ...
        <div className="flex flex-gap-10">
          <Button
            onClick={() => handleUpdateImage(profilePicture?._id)}
            className="mt-5"
            size="xs"
            variant="filled"
            radius="xl"
        ...
        <div className="flex flex-gap-10">
          <Button
            onClick={() => handleMakeProfile(profilePicture?._id)}
            className="mt-5"
            size="xs"
            variant="outline"
            radius="xl"
          ...
          <Button
            onClick={() => deletePhoto(profilePicture?._id)}
            className="mt-5"
            size="xs"
            color="red"
            variant="outline"
