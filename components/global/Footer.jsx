        ...
        <div className="footer_container py-30">
            ...
            <div className="footer container">
                <div className="footer__addr">
                    <img src="biye-korun-logo-with-tagline.png" alt="logo" loading="lazy" />
                ...
                <ul className="footer__nav">
                    <li className="nav__item">
                        ...
                        <ul className="nav__ul">
                            <li>
                                <Link className="contact-desc" href="/">Home</Link>
                            </li>

                            <li>
                                <Link className="contact-desc" href="/">Contact</Link>
                            </li>

                            <li>
                                <Link className="contact-desc" href="/about-us">About Us</Link>
                            </li>
                            ...
                            <li>
                                <Link className="contact-desc" href="/privacy-policy">Privacy Policy</Link>
                            </li>
                    ...
                    <li className="nav__item">
                        ...
                        <ul className="nav__ul">
                            <li>
                                <Link className="contact-desc" href="/login">Registration</Link>
                            </li>

                            <li>
                                <Link className="contact-desc" href="/">Partner Search</Link>
                            </li>

                            <li>
                                <Link className="contact-desc" href="/plans">Premium Membership</Link>
                            </li>
                        </ul>
                    </li>
                    ...
                    <p className="nav__item">
                        ...
                        <div className="mt-25">
                            <div className="flex flex-gap-5 contact-img">
                                ...
                                <p className="contact-desc"><b>USA Office: </b> 30500 Van Dyke, Ste - 201, Warren, MI 48093</p>
                            </div>
                            ...
                            <div className="flex flex-gap-5 contact-img">
                                <img alt="" src="/V3/landing/icon/location.svg" />
                                <p className="contact-desc"><b>Bangladesh Office: </b> 9143, Plot 2, Baunia Bazar, Uttara, Dhaka-1230 </p>
                            </div>
