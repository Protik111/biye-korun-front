...
const ComingSoon = () => {
  return (
    <div className="ComingSoon container flex flex-column justify-center align-center flex-gap-15">
      <div>
        <svg
      ...
      <h1>Coming soon!</h1>
      <Link href={"/dashboard"}>
        <button className="custom-button mt-20">Return Dashboard</button>
      </Link>
    </div>
  );
};
