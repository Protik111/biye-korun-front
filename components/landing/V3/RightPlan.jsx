    ...
    <div className="rightPlan container">
      ...
      <div className="rightPlan__wrapper">
        <div className="rightPlan__wrapper-item">
          ...
          <div className="list-container list-container2">
            ...
            <div className="lists">
              {list1?.map((item, i) => (
                <div className="flex align-center flex-gap-15 mt-10">
                  <img
                    src="/V3/landing/icon/check.svg"
                    loading="lazy"
                    alt="icon"
                  />
                  <p>{item}</p>
          ...
          <div className="list-container   ">
            ...
            <div className="lists">
              {list2?.map((item, i) => (
                <div className="flex align-center flex-gap-15 mt-10">
                  <img
                    src="/V3/landing/icon/check-2.svg"
                    loading="lazy"
                    alt="icon"
                  />
                  <p>{item}</p>
