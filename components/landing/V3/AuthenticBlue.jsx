      ...
      <div className="container">
        <div className="custom_grid">
          <div className="flex flex-column flex-gap-20">
            ...
            <p>
              The <span style={{ color: "#9908F5" }}>verified</span> badge means
              that BiyeKorun has confirmed that the Page or profile is the
              authentic presence of the individual, public figure that it
              represents. Previously, the verified badge also required the
              person to be notable and unique. You may still see users with a
