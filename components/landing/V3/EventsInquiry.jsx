...
const EventsInquiry = () => {
    ...
    const pickerControl = (
        <ActionIcon variant="subtle" color="white" onClick={() => ref.current?.showPicker()}>
            <IconClock style={{ width: rem(26), height: rem(26), color: "white" }} stroke={1.8} />
        </ActionIcon>
    );
        ...
        <div className='eventsInquiry'>
            <div className='eventsInquiry__wrapper container'>
                ...
                <div className='eventsInquiry__wrapper--right'>
                    ...
                    <div>
                        <Input width="100%" variant="filled" radius="md" size="xl" placeholder="Your Name..." />
                        <br />
                        <Input width="100%" variant="filled" radius="md" size="xl" placeholder="Your Partner Name *" />
                        <br />
                        <Input width="100%" variant="filled" radius="md" size="xl" placeholder="Email *" />
                        <br />
                        <Input width="100%" variant="filled" radius="md" size="xl" placeholder="Contact Number *" />
                        <br />
                        <DatePickerInput
                            clearable
                            // defaultValue={today}
